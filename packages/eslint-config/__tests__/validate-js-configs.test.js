...
describe('Validate JS configs', () => {
  it('Validate axiom-fe-eslint-config', async () => {
  ...
  it('Validate axiom-fe-eslint-config/es5', async () => {
  ...
  it('Validate axiom-fe-eslint-config/vue', async () => {
  ...
  it('Validate axiom-fe-eslint-config/essential', async () => {
  ...
  it('Validate axiom-fe-eslint-config/essential/es5', async () => {
  ...
  it('Validate axiom-fe-eslint-config/essential/react', async () => {
  ...
  it('Validate axiom-fe-eslint-config/essential/vue', async () => {
  ...
  it('Validate axiom-fe-eslint-config/node', async () => {
