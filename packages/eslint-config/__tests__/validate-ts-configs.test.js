...
describe('Validate TS configs', () => {
  it('Validate axiom-fe-eslint-config/typescript', async () => {
  ...
  it('Validate axiom-fe-eslint-config/typescript/vue', async () => {
  ...
  it('Validate axiom-fe-eslint-config/essential/typescript', async () => {
  ...
  it('Validate axiom-fe-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate axiom-fe-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate axiom-fe-eslint-config/typescript/node', async () => {
